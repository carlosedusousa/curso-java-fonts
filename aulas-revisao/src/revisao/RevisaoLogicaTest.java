...
public class RevisaoLogicaTest {
	...
	/*
	 * Crie o método "potencia" que receba um número do tipo inteiro como
	 * parametro e eleve ele ao cubo e retorne o resultado
	 */
	@Test
	...
	/*
	 * Cria o método "imc" que recebe altura e peso por parametro e calcule o
	 * índice de massa corporal de um indivíduo
	 */
	@Test
	public void imc() {
	 ...
	 * excedente. João precisa que você faça um método "multa" que calcule
	 * quanto de multa ele irá pagar para cada uma de suas pescas.
	 */
	@Test
	public void multa() {
	...
	/*
	 * Elabora um método "nadadores" que dada a idade de um nadador
	 * classifique-o em uma das seguintes categorias:
	 * 
	 * - Infantil A = 5 a 7 anos - Infantil B = 8 a 11 anos - Juvenil A = 12 a
	 ...
	 * se dar conta de que seria impossível efetuar o pagamento. Faça um método
	 * "mongePilantra" para calcular e retornar o número de grãos que o monge
	 * esperava receber.
	 * 
	...
	public void mongePilantra() {
		assertEquals(1.8446744073709552E19, RevisaoLogica.mongePilantra(),
				0.001);
	}
}