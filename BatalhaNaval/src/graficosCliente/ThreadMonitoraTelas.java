								...
								if (!cliente.getComandoEntrada().equals("$OK3")){
									...
									if (!entradaDados.equals(auxDados)){
										if (contador == 0){
											...
											System.out.println("cliente imagem: "+jogador.getImagem());
											cliente.getSaida().println("$OK");
										}
										else if (contador == 1){
