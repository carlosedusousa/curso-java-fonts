...
public class ArrayListas {
	...
	public static void main(String[] args) {
		...
		agenda.add("Juca Bala;11 1111-1111;12");
		agenda.add("Marcos Paqueta;22 2222-2222;12");
		agenda.add("Maria Antonieta;33 3333-3333;12");
		agenda.add("Antônio Conselheiro;44 4444-4444;12");
		agenda.add("teste");
