...
public class OficinaDaoMySQL extends JDBCConnect {
		...
		public void addVeiculo(Connection con, int cliente_id, java.util.Date date) throws SQLException, ParseException {
//			SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
//			java.util.Date aquisicaoDate = sdf.parse(aquisicao);
